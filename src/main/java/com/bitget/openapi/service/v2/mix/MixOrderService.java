...
public class MixOrderService {
    ...
    public ResponseResult orderDetail(Map<String, String> paramMap) throws IOException {
    ...
    public ResponseResult placeTpslOrder(Map<String, String> paramMap) throws IOException {
