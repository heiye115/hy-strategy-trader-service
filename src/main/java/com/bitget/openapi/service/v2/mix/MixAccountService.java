...
public class MixAccountService {
    ...
    public ResponseResult openCount(Map<String, String> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixAccountApi.openCount(paramMap).execute().body());
    }
}
