...
public class MixMarketService {
    ...
    public ResponseResult queryPositionLever(Map<String, String> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixMarketApi.queryPositionLever(paramMap).execute().body());
    }

    public ResponseResult historyCandles(Map<String, String> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixMarketApi.historyCandles(paramMap).execute().body());
    }
}
