...
@Slf4j
//@Service
public class DualMovingAverageStrategyV2Service {
    ...
    public DualMovingAverageStrategyV2Service(BitgetCustomService bitgetCustomService, @Qualifier("applicationTaskExecutor") TaskExecutor executor) {
