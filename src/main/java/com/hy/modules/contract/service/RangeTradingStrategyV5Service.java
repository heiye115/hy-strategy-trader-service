...
public class RangeTradingStrategyV5Service {
    ...
    public RangeTradingStrategyV5Service(BitgetCustomService bitgetCustomService, MailService mailService, @Qualifier("applicationTaskExecutor") TaskExecutor executor) {
