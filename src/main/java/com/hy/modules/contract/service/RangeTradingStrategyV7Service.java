...
@Slf4j
@Service
public class RangeTradingStrategyV7Service {
    ...
    public final static Map<String, RangePriceStrategyConfig> STRATEGY_CONFIG_MAP = new ConcurrentHashMap<>() {
        {
            ...
            put(SymbolEnum.BTCUSDT.getCode(), new RangePriceStrategyConfig(true, SymbolEnum.BTCUSDT.getCode(), 20, BigDecimal.valueOf(50.0), 4, 1, BitgetEnum.H1, 50.0, 30.0));
            // ETH配置：杠杆2倍，开仓金额50USDT，价格精度2位，数量精度2位
            put(SymbolEnum.ETHUSDT.getCode(), new RangePriceStrategyConfig(true, SymbolEnum.ETHUSDT.getCode(), 2, BigDecimal.valueOf(50.0), 2, 2, BitgetEnum.H1, 50.0, 30.0));
